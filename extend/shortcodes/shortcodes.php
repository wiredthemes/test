...
function add_plugin($plugin_array) {  
   $plugin_array['youtube'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['vimeo'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['soundcloud'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['button'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['dropcap'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['highlight'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['checklist'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['tabs'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['toggle'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['one_half'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['one_third'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['two_third'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['one_fourth'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['three_fourth'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['slider'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['testimonial'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';

   return $plugin_array;  
}

function add_plugin_2($plugin_array) {
   $plugin_array['progress'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['person'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['alert'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['pricing_table'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['recent_works'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['tagline_box'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['content_boxes'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['recent_posts'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['fontawesome'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['social_links'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['clients'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['title'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['separatoor'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
   $plugin_array['tfprettyphoto'] = get_template_directory_uri().'/admin/editor/tinymce/customcodes.js';
