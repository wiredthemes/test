			...
			<div class="post-content">
				...
				<div class="error_page">
					...
					<div class="one_third useful_links">
						<h3><?php echo __('Here are some useful links:', 'Inhouse'); ?></h3>
						<?php wp_nav_menu(array('theme_location' => '404_pages', 'depth' => 1, 'container' => false, 'menu_id' => '', 'menu_class' => 'arrow')); ?>
					</div>
					<div class="one_third last">
						<h3><?php echo __('Search Our Website', 'Inhouse'); ?></a></h3>
						<p><?php echo __('Can\'t find what you need? Take a moment and do a search below!', 'Inhouse'); ?></p>
						<?php get_search_form(); ?>
					</div>
				</div>
			</div>
